...
(function (factory) {
  ...
  function bulkUpdateCSS(data) {
   // executeNextFrame(function() { Cancel this animation will be better performance Kenny Lee
      var i, item;
  ...
  Wookmark = (function() {
    ...
    function Wookmark(handler, options) {
      ...
      //this.updateFilterClasses = __bind(this.updateFilterClasses, this); //Cancel this animation will be better performance. Kenny Lee

      // Initial update of the filter classes
      //this.updateFilterClasses(); //Cancel this animation will be better performance. Kenny Lee
    ...
    Wookmark.prototype.layout = function(force) {
      ...
      var columnWidth = this.getItemWidth() + this.offset,
          ...
          //innerWidth = containerWidth - 2 * this.outerOffset, //Kenny Fix
    ...
    Wookmark.prototype.layoutFull = function(columnWidth, columns, offset) {
      ...
      // activeItems = this.sortElements(activeItems); //Cancel this animation will be better performance. Kenny Lee
      ...
      for (; i < length; i++ ) {
		...
		// trim left and right margin . Kenny Lee 
		/*if ( shortestIndex == 0) {
		   sideOffset = 0;
		} else //if (shortestIndex == columns - 1) 
		   sideOffset += offset * (shortestIndex ) ;*/
